...
import SidebarItem from "apps/seller-ui/src/shared/components/Sidebar/sidebar.item";
import SidebarMenu from "apps/seller-ui/src/shared/components/Sidebar/sidebar.menu";
        ...
        <Box>
          <Link href={"/"} className="flex justify-center text-center gap-2">
            ...
            <Box>
              ...
              <h5 className="font-medium pl-2 text-xs text-white whitespace-nowrap overflow-hidden text-ellipsis max-w-[170px] truncate">
                {seller?.shop?.address ?? ""}
              </h5>
            </Box>
          </Link>
