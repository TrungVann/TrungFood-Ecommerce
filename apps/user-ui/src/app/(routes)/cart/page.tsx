                    ...
                    <td className="px-6 text-lg text-center">
                      {item?.id === discountedProductId ? (
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-xs text-green-700 bg-green-500">
                            Discount Applied
                          </span>
                        </div>
                      ) : (
              ...
              <div className="mb-4">
                ...
                <div className="flex">
                  <input
                    ...
                    className="w-full p-2 border border-gray-200 rounded-l-md focus:outline focus:border-blue-500"
                  />
                  <button
                ...
                <div className="mb-4">
                  ...
                  >
                    <option value="123">Home - Hà Nội - Việt Nam</option>
                  </select>
                </div>
                <hr className="my-4 text-slate-200" />
                ...
                <button disabled={loading} className="w-full flex items-center justify-center gap-2 cursor-pointer mt-4 py-3 bg-[#010f1c]">
