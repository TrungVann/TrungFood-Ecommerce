  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3">
        {fields?.map((item, index) => (
          <div key={index} className="flex gap-2 items-center">
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  placeholder="e.g., FastFood, Vegetable,..."
                  {...field}
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <Input label="Value" placeholder="e.g., 1.5kg, 1g,..." />
              )}
            />
            <button
              type="button"
        ...
        <button className="flex items-center gap-2 text-blue-500 hover:text-blue-600" onClick={() => append({name:"", value:""})}>
